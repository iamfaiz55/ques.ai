...
//         {/* SVG Icon */}
//         <div className="">
//         <svg width="187" height="30" viewBox="0 0 187 40" fill="none" xmlns="http://www.w3.org/2000/svg">
...
//                     </button>
//                       <button onClick={()=> signOut()} className="text-purple-800  bg-white rounded-full p-2">
...
import { IoMdNotificationsOutline } from "react-icons/io";
import { IoSettingsOutline } from "react-icons/io5";
import { AiOutlineUser } from "react-icons/ai"; // Import account icon
import { useSignOutMutation } from "../redux/apis/authApi";
import { useEffect } from "react";
import { toast } from "sonner";
import { useNavigate } from "react-router";
  ...
  return (
    <nav className="m-6">
      <div className="flex items-center justify-between">
        ...
        {/* Menu Items */}
        <div className="flex justify-between w-20 mr-20">
          {/* Account Icon */}
          <button
            onClick={() => navigate("/project/account")}
            className="text-purple-800 bg-white rounded-full p-2"
          >
            <AiOutlineUser size={30} color="#7E22CE" />
          </button>
